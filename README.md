...
[System Recovery] Your previous output contained an invalid signature.
    ...
    *   **v3.3.17 (2026-01-08)**:
        - **OpenAI 协议 Thinking 展示增强 (核心致谢 @Mag1cFall PR #411)**:
            ...
            - **影响范围**: 此功能增强了 Gemini 3 thinking 模型在 Cherry Studio 等各类 IDE 客户端中的展示效果,思考过程可以被正确折叠,不影响任何现有 v3.3.16 修复。
    ...
    *   **v3.3.16 (2026-01-07)**:
        ...
        - **高并发性能优化 (Issue #284 修复)**:
            ...
            - **影响范围**: 此优化显著提升了多 Agent 并发场景（如 Claude Code 等）的稳定性，解决了"有头无尾\"的请求卡死问题。
    ...
    *   **v3.3.15 (2026-01-04)**:
        - **Claude 协议兼容性增强** (基于 PR #296 by @karasungur + Issue #298 修复):
            ...
            - **影响范围**: 这些改进显著提升了 Claude Code、Cherry Studio 等 IDE 客户端的兼容性和稳定性,特别是在 Opus 4.5 模型、工具调用和多轮对话场景下。
    *   **v3.3.14 (2026-01-03)**:
        - **Claude 协议鲁棒性改进** (核心致谢 @karasungur PR #289):
            ...
            - **SSE 解析错误恢复机制**:
                ...
                - 详细的调试日志,支持故障排查损坏流
            - **影响范围**: 这些改进显著提升了 Claude CLI、Cherry Studio 等 IDE 客户端的稳定性,特别是在多轮对话、工具调用和流式响应场景下。
    ...
    *   **v3.3.12 (2026-01-02)**:
        - **核心修复 (Critical Fixes)**:
            - **修复 Antigravity Thinking Signature 错误**: 解决了使用 Antigravity (Google API) 渠道时的 `400: thinking.signature: Field required` 错误。
                ...
                - **影响范围**: 此修复确保了 Claude CLI、Cherry Studio 等 IDE 客户端在使用 Antigravity 代理时的稳定性，特别是在多轮对话和工具调用场景下。
    *   **v3.3.11 (2026-01-02)**:
        - **重要修复 (Critical Fixes)**:
    ...
    *   **v3.3.9 (2026-01-01)**:
        - 🚀 **全协议调度对齐**: `Scheduling Mode` 现在正式覆盖 OpenAI (IDE/Cherry)、Gemini 原生及 Claude 协议。
