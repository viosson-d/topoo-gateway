...
static CLAUDE_TO_GEMINI: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    ...
    // OpenAI 协议映射表 - 映射到实际能工作的 Gemini 3 系列
    m.insert("gpt-4", "gemini-3-flash");
    m.insert("gpt-4-turbo", "gemini-3-flash");
    m.insert("gpt-4-turbo-preview", "gemini-3-flash");
    m.insert("gpt-4-0125-preview", "gemini-3-flash");
    m.insert("gpt-4-1106-preview", "gemini-3-flash");
    m.insert("gpt-4-0613", "gemini-3-flash");

    m.insert("gpt-4o", "gemini-3-flash");
    m.insert("gpt-4o-2024-05-13", "gemini-3-flash");
    m.insert("gpt-4o-2024-08-06", "gemini-3-flash");

    m.insert("gpt-4o-mini", "gemini-3-flash");
    m.insert("gpt-4o-mini-2024-07-18", "gemini-3-flash");

    m.insert("gpt-3.5-turbo", "gemini-3-flash");
    m.insert("gpt-3.5-turbo-16k", "gemini-3-flash");
    m.insert("gpt-3.5-turbo-0125", "gemini-3-flash");
    m.insert("gpt-3.5-turbo-1106", "gemini-3-flash");
    m.insert("gpt-3.5-turbo-0613", "gemini-3-flash");
    ...
    m.insert("gemini-3-pro-preview", "gemini-3-pro-high");
    m.insert("gemini-3-pro", "gemini-3-pro-high"); // Map generic Pro to Pro High
    m.insert("gemini-2.5-flash", "gemini-2.5-flash");
    m.insert("gemini-3-flash", "gemini-3-flash"); // [VERIFIED] Valid in internal logs
